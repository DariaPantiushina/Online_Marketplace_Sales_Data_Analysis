...
- The script fetch_all_sales_data.py was developed to populate the database with all available historical sales data from the API (starting on 2024-01-01). The script includes a mechanism to prevent re-downloading data for days that have already been retrieved.
