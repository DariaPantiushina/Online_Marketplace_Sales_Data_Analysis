...
The **tasks** include: 1) identification of key growth metrics, 2) optimization of the product range matrix, 3) analysis of the effectiveness of the pricing policy, 4) examination of customer behavior.
